	...
	implements org.omg.CORBA.portable.InvokeHandler, com.u1654949.corba.ls.TLSOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "register_tms", Integer.valueOf(1));
		m_opsHash.put ( "get_registered_tms", Integer.valueOf(2));
		m_opsHash.put ( "get_current_state", Integer.valueOf(3));
		m_opsHash.put ( "ping", Integer.valueOf(4));
		m_opsHash.put ( "_get_alarm_log", Integer.valueOf(5));
		m_opsHash.put ( "remove_tms", Integer.valueOf(6));
...
_out.write_string( tmpResult8 );
			...
			case 2: // get_registered_tms
			{
				_out = handler.createReply();
				com.u1654949.corba.common.StationsHelper.write(_out,get_registered_tms());
				break;
			}
