...
public abstract class RegionHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(RegionHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_alias_tc(com.u1654949.corba.common.RegionHelper.id(), "Region",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.CORBA.ORB.init().create_string_tc(0)));
				}
			}
		}
		return _type;
	...
	{
		return "IDL:com/u1654949/corba/common/Region:1.0";
	}
	...
	public static void write (final org.omg.CORBA.portable.OutputStream _out, java.lang.String[] _s)
	{
		...
		{
			java.lang.String tmpResult5 = _s[i];
