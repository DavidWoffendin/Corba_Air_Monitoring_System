...
public class _TMSStub
	...
	implements com.u1654949.corba.ms.TMS
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = com.u1654949.corba.ms.TMSOperations.class;
	...
	public boolean deactivate()
	{
		...
		else
		{
			...
			try
			{
				_result = _localServant.deactivate();
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					_is = _invoke(_os);
					com.u1654949.corba.common.NoxReading _result = com.u1654949.corba.common.NoxReadingHelper.read(_is);
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void send_alarm(int measurement)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "send_alarm", true);
					_os.write_long(measurement);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "send_alarm", _opsClass );
			if( _so == null )
				continue;
			TMSOperations _localServant = (TMSOperations)_so.servant;
			try
			{
				_localServant.send_alarm(measurement);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public com.u1654949.corba.common.NoxReading[] get_reading_log()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "get_reading_log", true);
					_is = _invoke(_os);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "get_reading_log", _opsClass );
			if( _so == null )
				continue;
			TMSOperations _localServant = (TMSOperations)_so.servant;
			com.u1654949.corba.common.NoxReading[] _result;
			try
			{
				_result = _localServant.get_reading_log();
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
