...
public class _MCSStub
	...
	implements com.u1654949.corba.mc.MCS
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = com.u1654949.corba.mc.MCSOperations.class;
...
_os.write_string( tmpResult12 );
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "remove_tls_connection", _opsClass );
			if( _so == null )
				continue;
			MCSOperations _localServant = (MCSOperations)_so.servant;
			boolean _result;
			try
			{
				_result = _localServant.remove_tls_connection(name);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult13 = county;
...
_os.write_string( tmpResult14 );
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "get_connected_tls", _opsClass );
			if( _so == null )
				continue;
			MCSOperations _localServant = (MCSOperations)_so.servant;
			com.u1654949.corba.ls.TLS _result;
			try
			{
				_result = _localServant.get_connected_tls(name);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
	...
	public java.lang.String[] get_known_servers()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "get_known_servers", true);
					_is = _invoke(_os);
					java.lang.String[] _result = com.u1654949.corba.common.TLS_ListHelper.read(_is);
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "get_known_servers", _opsClass );
			if( _so == null )
				continue;
			MCSOperations _localServant = (MCSOperations)_so.servant;
			java.lang.String[] _result;
			try
			{
				_result = _localServant.get_known_servers();
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
...
_os.write_string( tmpResult15 );
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "get_alarms", _opsClass );
			if( _so == null )
				continue;
			MCSOperations _localServant = (MCSOperations)_so.servant;
			com.u1654949.corba.common.Alarm[] _result;
			try
			{
				_result = _localServant.get_alarms(id);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
	...
	public void cancel_alarm(com.u1654949.corba.common.TLSData tls_data)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "cancel_alarm", true);
					com.u1654949.corba.common.TLSDataHelper.write(_os,tls_data);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "cancel_alarm", _opsClass );
			if( _so == null )
				continue;
			MCSOperations _localServant = (MCSOperations)_so.servant;
			try
			{
				_localServant.cancel_alarm(tls_data);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
...
_os.write_string( tmpResult16 );
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "register_tls_connection", _opsClass );
			if( _so == null )
				continue;
			MCSOperations _localServant = (MCSOperations)_so.servant;
			boolean _result;
			try
			{
				_result = _localServant.register_tls_connection(name);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
